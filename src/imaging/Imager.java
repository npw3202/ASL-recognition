...
public class Imager extends Listener {
	 ...
	 *
	 * @param c
	 *            the controller (this is a listener for the controller)
	 */
	 ...
	 *
	 * @param imageNum
	 *            the image to get (0 for left, 1 for right)
	...
	/**
	 * When an image is available save it NOTE: automatically called, do not
	 * call manually
	 *
	 * @param c
	 *            the controller
